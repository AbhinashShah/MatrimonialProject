...
<!-- head -->
<head>
<title>Match a Matrimonial Category Bootstrap Responsive Web Template | Terms and Conditions :: w3layouts</title>
...
<!-- /header -->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.php">Home</a> > <span>Terms and Conditions</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
			...
			<div class="terms">
				<div class="container">
					...
					<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>
						...
						<h6>Role and Responsibility of BM</h6>
