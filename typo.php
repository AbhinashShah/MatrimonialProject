...
<!-- head -->
<head>
<title>Match a Matrimonial Category Bootstrap Responsive Web Template | Typography :: w3layouts</title>
...
<!-- /header -->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.php">Home</a> > <span>Typography</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
	   ...
	   <!-- shortcodes-section -->
		<section class="typography">
			...
			<div class="shortcodes">
				<div class="container">
			         <h3 class="w3-head">Typography</h3>
