...
<!-- head -->
<head>
<title>Match a Matrimonial Category Bootstrap Responsive Web Template | Contact :: w3layouts</title>
								...
								<div>
									<section class="w3_g_address">
										...
										<ul>
											...
											<li><span>Customercare</span>: <a href="writeus.php">Click here</a> </li>
										</ul>
										<h3>Locate Us:</h3>
